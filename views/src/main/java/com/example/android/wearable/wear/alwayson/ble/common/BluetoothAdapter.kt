package com.example.android.wearable.wear.alwayson.ble.common
...
fun isBluetoothEnabledFlow(): Flow<Boolean> = bluetoothStateFlow().map { state ->
    state == BluetoothState.On
}.distinctUntilChanged()

@RequiresPermission(Manifest.permission.BLUETOOTH)
fun bluetoothStateFlow(): Flow<BluetoothState> = broadcastReceiverFlow(
